    ...
    <div className="w-full">
      ...
      <div className="px-4 py-6">
        <div className="flex flex-col md:flex-row gap-6 items-start">
          ...
          {user && user?._id === channel?._id && (
            <div className="flex flex-col items-end gap-2 bg-gray-50 p-3 rounded-lg border border-gray-100">
              <span className="text-xs text-gray-500 font-medium">Your Subscription</span>
              <Button
                variant="outline"
                className="flex items-center gap-2 border-red-200 hover:bg-red-50 text-red-600 font-semibold"
